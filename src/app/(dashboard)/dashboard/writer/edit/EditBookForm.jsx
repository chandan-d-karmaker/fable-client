...
import { publishEbook, updateEbook } from "@/lib/actions/ebooks";

export default function EditEbookForm({ initialData }) {
        ...
        <div className="w-full max-w-4xl mx-auto py-4 text-foreground">
            ...
            <div className="bg-background border border-divider rounded-nome p-4 sm:p-6 shadow-sm">
                ...
                <Form onSubmit={handleSubmit} className="flex flex-col gap-8 w-full">
                    ...
                    {/* Book Title */}
                    <TextField defaultValue={initialData?.title} isRequired name="title" className="w-full">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
                        <TextField defaultValue={initialData?.genre} isRequired name="genre" className="w-full">
                            <Label className={labelClass}>Genre</Label>
                            <Input  placeholder="Fantasy" className={baseInputClass} />
                        </TextField>

                        <TextField defaultValue={initialData?.price} isRequired name="price" className="w-full">
                    ...
                    {/* Short Description */}
                    <TextField defaultValue={initialData?.description} isRequired name="description" className="w-full">
                    ...
                    <div className="flex justify-end pt-4 mt-4 border-t border-divider">
                        ...
                        >
                            {isLoading ? <Spinner size="sm" color="current" /> : "Update Ebook"}
                        </Button>
                    </div>
